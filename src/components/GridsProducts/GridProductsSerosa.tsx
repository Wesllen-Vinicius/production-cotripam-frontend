...
const product = {
  ...
  description:
    'Extraida do bucho bovino, especificamente da tripa bovina, é feito o processo de limpeza e tratamento até alcançar os padrões cotripam de qualidade, após isso, são realizados os cortes por uma maquina especifica para este processo, hoje produzidas pela propria cotripam para a produção de seus materiais. Uma vez cortada a serosa entra no processo de salga e preparo para o transporte até a comarca de tratamento e armazenamento, para após isso, comercialização.',
  highlights: [
...
export default function GridSerosa() {
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-gray-900">- Cortes Disponiveis - Trabalhamos tambem com cortes especiais.</h3>
                </div>
