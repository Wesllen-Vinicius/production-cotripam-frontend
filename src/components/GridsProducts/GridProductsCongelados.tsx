...
const product = {
  ...
  images: [
    {
      src: '/src/assets/culatraResfriada.jpg',
      alt: 'Culatra em natura, pronta para resfriamento.',
    },
    {
      src: '/src/assets/abomasoCongelado.jpg',
      alt: 'Abomaso tratado para resfriamento.',
    },
    {
    ...
    {
      src: '/src/assets/producao2.jpg',
      alt: 'Produtos sendo preparados para resfriamento.',
    },
  ],
  description:
    'Trabalhamos com, culatra, mocoto, tripa-grossa, tripa-fina, kit-panelada pronto para consumo, abomaso, esses produtos são mantidos em nossas unidades de resfriamento em natura.',
  highlights: [
...
export default function GridCongelados() {
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-gray-900">- Informações dos produtos</h3>
                </div>
